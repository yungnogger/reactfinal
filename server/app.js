...
const secret = process.env.SECRET || "the cake is a not a lie, you just have to look for it";
...
mongoose.connect(MONGO_URL, {useNewUrlParser: true, useUnifiedTopology: true})
    .then(async () => {
        ...
        await categoryDAL.bootstrapCategory();
        ...
        app.use('/api/books', questionRouter);
